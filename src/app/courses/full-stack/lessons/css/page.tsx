import CssLessonSlides from "@/components/full-stack/css-slides";
import { ArrowLeft } from "lucide-react";
import Link from "next/link";

export const metadata = {
  title: "CSS Creative Styling | Full-Stack Curriculum",
  description: "Learn how to make the web beautiful with interactive CSS slides.",
};
      ...
      <nav className="p-4 pointer-events-none">
        <div className="max-w-7xl mx-auto flex items-center justify-between pointer-events-auto">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/5 bg-black/20 backdrop-blur-sm">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/30">Module 02: CSS Mastery</span>
          </div>
        </div>
      </nav>
