import GitLessonSlides from "@/components/lessons/git-slides";
import { ArrowLeft } from "lucide-react";
import Link from "next/link";

export const metadata = {
  title: "Git & GitHub Mastery | Full-Stack Curriculum",
  description: "Master version control and cloud collaboration with interactive terminal lessons.",
};
    ...
    <main className="min-h-screen bg-[#080c14] overflow-hidden">
      ...
      <nav className="p-4 pointer-events-none ">
        <div className="max-w-lg mx-auto flex items-center justify-between pointer-events-auto">
          ...
          >
            <div className="w-8 h-8 rounded-full bg-orange-500/20 flex items-center justify-center group-hover:scale-110 transition-transform">
          ...
          <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-white/5 bg-black/20 backdrop-blur-sm">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-white/30">Module 04: Week 07</span>
          </div>
        </div>
      </nav>
